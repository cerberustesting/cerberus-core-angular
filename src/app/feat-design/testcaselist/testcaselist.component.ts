...
export class TestcaselistComponent implements OnInit {
  ...
  constructor( private testService: TestService, private invariantsService: InvariantsService, private labelfilteringPipe: LabelfilteringPipe, private filterService: FilterService ) { }
